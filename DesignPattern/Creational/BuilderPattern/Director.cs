namespace BuilderPattern
{
    ...
    {
        private readonly Computer hp = new() { Band = "惠普" };
    ...
    {
        private readonly Computer dell = new() { Band = "戴尔" };
    ...
    public class Computer
    {
        ...
        /// 电脑组件列表
        /// </summary>
        private readonly List<string> assemblyParts = [];
        ...
        public void ShowSteps()
        {
            ...
            foreach (string part in assemblyParts)
            {
